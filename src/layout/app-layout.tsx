...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const { data, error, isLoading } = useSWR<HospitalInterface[]>(
    ...
    () => getHospitals({ tenant_id: session?.user?.tenantId }).then(({ data }) => data),
  );
  loading = isLoading;
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Hpc Decision Makings',
      path: '/hpc-decision-makings',
      entity: 'hpc_decision_makings',
      service: AccessServiceEnum.PROJECT,
      icon: FiCheckSquare,
    },
    {
      name: 'Hpc Meeting Evaluations',
      path: '/hpc-meeting-evaluations',
      entity: 'hpc_meeting_evaluations',
      service: AccessServiceEnum.PROJECT,
      icon: FiFileText,
    },
    {
      name: 'Hpc Meeting Members',
      path: '/hpc-meeting-members',
    ...
    {
      name: 'New Tablepatient Treatments',
      path: '/new-tablepatient-treatments',
      entity: 'new_tablepatient_treatments',
      service: AccessServiceEnum.PROJECT,
      icon: FiHeart,
    },
    { name: 'Patients', path: '/patients', entity: 'patient', service: AccessServiceEnum.PROJECT, icon: FiUser },
    {
      name: 'Patient Substance Uses',
      path: '/patient-substance-uses',
      entity: 'patient_substance_use',
      service: AccessServiceEnum.PROJECT,
      icon: FiCoffee,
    },
    {
      name: 'Patient Symptom Reports',
      path: '/patient-symptom-reports',
