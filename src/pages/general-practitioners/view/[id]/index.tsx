      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'General Practitioners Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('general_practitioners', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/general-practitioners/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Personal Phone" text={data?.personal_phone} />

                <FormListItem label="Office Phone" text={data?.office_phone} />
              </List>
            </FormWrapper>

            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6} p={'18px'}>
              <PatientListPage
                filters={{ general_practitioner_id: id }}
                hidePagination={true}
