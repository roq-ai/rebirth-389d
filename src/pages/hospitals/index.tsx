...
type ColumnType = ColumnDef<HospitalInterface, unknown>;
...
export function HospitalListPage(props: HospitalListPageProps) {
  const {
    filters = {},
    titleProps = {},
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<HospitalInterface>>(
    () => `/hospitals?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/hospitals/view/${record.id}`} passHref legacyBehavior>
                <Button
