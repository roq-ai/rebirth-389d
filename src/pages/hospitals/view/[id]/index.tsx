            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('hospital', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/hospitals/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="hospital" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
              ...
              >
                ...
                <FormListItem label="Identifier" text={data?.identifier} />
