...
import { getHpcDecisionMakingsById } from 'apiSdk/hpc-decision-makings';
import { HpcDecisionMakingsInterface } from 'interfaces/hpc-decision-makings';

function HpcDecisionMakingsViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Hpc Decision Makings Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Hpc Decision Makings Details
                  </Text>
                </Box>
                {hasAccess('hpc_decision_makings', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/hpc-decision-makings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Life Expectancy Without Cancer" text={data?.life_expectancy_without_cancer} />

                <FormListItem label="Life Expectancy Untreated" text={data?.life_expectancy_untreated} />

                <FormListItem label="Burden Cancer Untreated" text={data?.burden_cancer_untreated} />

                <FormListItem label="Add Life Expectancy" text={data?.add_life_expectancy} />
