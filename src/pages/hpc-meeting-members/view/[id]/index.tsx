...
import { getHpcMeetingMembersById } from 'apiSdk/hpc-meeting-members';
import { HpcMeetingMembersInterface } from 'interfaces/hpc-meeting-members';

function HpcMeetingMembersViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Hpc Meeting Members Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Hpc Meeting Members Details
                  </Text>
                </Box>
                {hasAccess('hpc_meeting_members', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/hpc-meeting-members/edit/${id}`} passHref legacyBehavior>
                    <Button
