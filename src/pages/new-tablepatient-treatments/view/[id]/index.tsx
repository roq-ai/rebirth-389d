...
import { getNewTablepatientTreatmentsById } from 'apiSdk/new-tablepatient-treatments';
import { NewTablepatientTreatmentsInterface } from 'interfaces/new-tablepatient-treatments';

function NewTablepatientTreatmentsViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'New Tablepatient Treatments Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    New Tablepatient Treatments Details
                  </Text>
                </Box>
                {hasAccess('new_tablepatient_treatments', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/new-tablepatient-treatments/edit/${id}`} passHref legacyBehavior>
                    <Button
...
)(NewTablepatientTreatmentsViewPage);
