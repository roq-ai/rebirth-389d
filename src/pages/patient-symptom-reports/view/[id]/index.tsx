...
import { getPatientSymptomReportById } from 'apiSdk/patient-symptom-reports';
import { PatientSymptomReportInterface } from 'interfaces/patient-symptom-report';

function PatientSymptomReportViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Patient Symptom Report Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Patient Symptom Report Details
                  </Text>
                </Box>
                {hasAccess('patient_symptom_report', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/patient-symptom-reports/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Mood" text={data?.mood} />

                <FormListItem label="Streak" text={data?.streak} />

                <FormListItem label="Any Severe" text={data?.any_severe} />

                <FormListItem label="Any Other Symptoms" text={data?.any_other_symptoms} />
