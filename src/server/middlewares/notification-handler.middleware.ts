...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Patient Admission.create': {
    ...
    key: 'patient_admission',
    tenantPath: [],
    userPath: [],
  },
  'Patient Condition Update.update': {
    roles: [
      'hospital-admin',
      'medical-staff',
      'nurse-staff',
    ...
    key: 'patient_condition_update',
    tenantPath: [],
    userPath: [],
  },
  'Patient Discharge.delete': {
    roles: [
      'hospital-admin',
      'medical-staff',
      'nurse-staff',
    ...
    key: 'patient_discharge',
    tenantPath: [],
    userPath: [],
  },
};

const ownerRoles: string[] = ['hospital-admin'];
